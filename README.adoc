...
Update the cluster host IP in the following CR.

* link:./deploy/crds/mobile-security-service_v1alpha1_mobilesecurityservice_cr.yaml[MobileSecurityService CR]
...
* Create a BIND CR for the application as the example link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityservicebind_cr.yaml[MobileSecurityServiceBind CR]
+
* Add into the link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityservicebind_cr.yaml[MobileSecurityServiceBind CR] the app name and id of the app which will be bind to the Service as follows.
+
[source,shell]
----
...
----
+
IMPORTANT: Do not forget to update the clusterHost in the BIND CR
+
* Run the following command to bind the app to the service
+
[source,shell]
----
$ make bind
----
+
NOTE: If you would like to have more than one app bind to the Service per namespace than change the metadata.name` of the bind link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityservicebind_cr.yaml[MobileSecurityServiceBind CR]

=== Unbinding an app
* Create a UNBIND CR for the application as the example link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR]
+
* Add into the link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR] the app id of the app which will be unbind from the Service as follows.
+
[source,shell]
----
  # The appId spec defines the appId of the app used to bind the service
...
----
+
IMPORTANT: Do not forget to update the clusterHost in the UNBIND CR
+
...
----
+
NOTE: If you would like to have more than one app unbind from the Service per namespace than change the metadata.name` of the ubind link:./deploy/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR]
...
| link:./deploy/crds/mobile-security-service_v1alpha1_mobilesecurityservicebind_crd.yaml[MobileSecurityServiceBind]             | Creates and update the app in the Service REST API.
| link:./deploy/crds/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_crd.yaml[MobileSecurityServiceUnbind]             | Delete the app in the Service REST API.
|===
...
| `make bind`                   | Create the example Bind CR and delete the example Unbind CR for an app in the current namespace which will create a SDK configMap for the app and create and/or update the app in the Service
| `make unbind`                 | Delete the example Bind CR and apply the example Unbind CR for an app in the current namespace which will delete/disable the app in the Service
