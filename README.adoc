...
* Create a BIND CR for the application as the example link:./deploy/crds/examples/mobile-security-service_v1alpha1_mobilesecurityservicebind_cr.yaml[MobileSecurityServiceBind CR]
+
* Add into the link:./deploy/crds/examples/mobile-security-service_v1alpha1_mobilesecurityservicebind_cr.yaml[MobileSecurityServiceBind CR] the app name and id of the app which will be bind to the Service as follows.
+
[source,shell]
----
...
=== Unbinding an app
* Create a UNBIND CR for the application as the example link:./deploy/crds/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR]
+
* Add into the link:./deploy/crds/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR] the app id of the app which will be unbind from the Service as follows.
+
[source,shell]
----
  # The appId spec defines the appId of the app used to bind the service
...
----
+
NOTE: If you would like to have more than one app unbind from the Service per namespace than change the metadata.name` of the ubind link:./deploy/crds/examples/mobile-security-service_v1alpha1_mobilesecurityserviceunbind_cr.yaml[MobileSecurityServiceUnbind CR]
