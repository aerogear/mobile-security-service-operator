...
- Fixing nomenclature of CR/CRD's in order to keep it as it is generated by the make command code/run currently[#158](https://github.com/aerogear/mobile-security-service-operator/pull/158)
