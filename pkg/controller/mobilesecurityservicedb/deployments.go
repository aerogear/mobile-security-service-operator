...
func (r *ReconcileMobileSecurityServiceDB) buildDBDeployment(m *mobilesecurityservicev1alpha1.MobileSecurityServiceDB, serviceConfigMapName string) *v1beta1.Deployment {
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					Containers: []corev1.Container{{
						...
						Env: []corev1.EnvVar{
							r.getDatabaseNameEnvVar(m, serviceConfigMapName),
							r.getDatabaseUserEnvVar(m, serviceConfigMapName),
							r.getDatabasePasswordEnvVar(m, serviceConfigMapName),
							{
								Name:  "PGDATA",
