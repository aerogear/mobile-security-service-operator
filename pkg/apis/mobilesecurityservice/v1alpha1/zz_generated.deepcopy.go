...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MobileSecurityServiceMonitor) DeepCopyInto(out *MobileSecurityServiceMonitor) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MobileSecurityServiceMonitor.
func (in *MobileSecurityServiceMonitor) DeepCopy() *MobileSecurityServiceMonitor {
	if in == nil {
		return nil
	}
	out := new(MobileSecurityServiceMonitor)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MobileSecurityServiceMonitor) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MobileSecurityServiceMonitorList) DeepCopyInto(out *MobileSecurityServiceMonitorList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MobileSecurityServiceMonitor, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MobileSecurityServiceMonitorList.
func (in *MobileSecurityServiceMonitorList) DeepCopy() *MobileSecurityServiceMonitorList {
	if in == nil {
		return nil
	}
	out := new(MobileSecurityServiceMonitorList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MobileSecurityServiceMonitorList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MobileSecurityServiceMonitorSpec) DeepCopyInto(out *MobileSecurityServiceMonitorSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MobileSecurityServiceMonitorSpec.
func (in *MobileSecurityServiceMonitorSpec) DeepCopy() *MobileSecurityServiceMonitorSpec {
	if in == nil {
		return nil
	}
	out := new(MobileSecurityServiceMonitorSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MobileSecurityServiceMonitorStatus) DeepCopyInto(out *MobileSecurityServiceMonitorStatus) {
	*out = *in
	if in.Nodes != nil {
		in, out := &in.Nodes, &out.Nodes
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MobileSecurityServiceMonitorStatus.
func (in *MobileSecurityServiceMonitorStatus) DeepCopy() *MobileSecurityServiceMonitorStatus {
	if in == nil {
		return nil
	}
	out := new(MobileSecurityServiceMonitorStatus)
	in.DeepCopyInto(out)
	return out
}
